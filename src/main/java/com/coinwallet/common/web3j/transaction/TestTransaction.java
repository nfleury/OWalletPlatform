...
public class TestTransaction {
    ...
    public static void testVerifyTransactionOnNode() throws IOException {


        Web3j web3j = Web3j.build(new CustomNodeService());
        TransactionVerificationInfo transactionVerificationInfo = TransactionOnNode.verifyTransaction(test_TxHash_main);
        System.out.println("verify:"+transactionVerificationInfo.isVerification());
//        System.out.println("");
//        System.out.println("");
    }
