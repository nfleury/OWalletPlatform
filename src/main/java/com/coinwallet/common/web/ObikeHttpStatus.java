...
/**
 * oBike自定义异常值字典类
 * 由于某些异常类需要和前端一起定义  所以需要自定义某些code
 */
public enum ObikeHttpStatus {
     ...
     * 手机号码已注册
     */
    PHONE_REGISTER_ALREADY(1001,"Phone Register Already");
    ...
    ObikeHttpStatus(int value, String reasonPhrase) {
        this.value = value;
    ...
    public boolean is2xxSuccessful() {
        return ObikeHttpStatus.Series.SUCCESSFUL.equals(series());
    }
     ...
     */
    public ObikeHttpStatus.Series series() {
        return ObikeHttpStatus.Series.valueOf(this);
    }
     ...
     */
    public static ObikeHttpStatus valueOf(int statusCode) {
        for (ObikeHttpStatus status : values()) {
    ...
    public enum Series {
        ...
        public static ObikeHttpStatus.Series valueOf(int status) {
            int seriesCode = status / 100;
            for (ObikeHttpStatus.Series series : values()) {
        ...
        public static ObikeHttpStatus.Series valueOf(ObikeHttpStatus status) {
