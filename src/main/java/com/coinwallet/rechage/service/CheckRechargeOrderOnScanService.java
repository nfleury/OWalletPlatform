            ...
            for (TransactionsResponse.CustomTransaction transaction : scanBlockInfo.getTransactionList()) {
                ...
                if (userWalletInfo != null) {
                    ...
                    if (transactionOrder != null) {
                        ...
                        int i = checkRechargeOrderOnNodeService.insertTransacntionOrder(transaction, toAddress, Constants.ORDER_TYPE_USER_RECHARGE, coinInfo, Constants.ORDER_STATUS_SUCCESS, transactionOrder);
                        updateUserBalanceAndRecordLog(userWalletInfo, transactionOrder, i);
                    }
                }
            }
