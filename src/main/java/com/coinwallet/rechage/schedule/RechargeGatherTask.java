    ...
    public void configureTasks(ScheduledTaskRegistrar scheduledTaskRegistrar) {
        ...
        scheduledTaskRegistrar.addTriggerTask(
                () -> {
                    ...
                    criteria.andCoinBalanceBetween(new BigDecimal(coinInfo.getCoinLowerLimit().toString()), new BigDecimal(coinInfo.getCoinHigherLimit().toString()));
